...
echo "Removing preexisting dnavcw environment if exists"
source deactivate
conda remove --name dnavcw --all --yes;

echo "Creating the new dnavcw environment from environment.yml"
...
rm -rf test;
wget https://s3-us-west-1.amazonaws.com/mdurrant/biodb/bundles/dnaseq_variant_calling_workflow/test.tar.gz;
